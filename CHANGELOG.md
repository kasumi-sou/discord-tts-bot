...
- アップデート通知エンベッドの文言を調整 (d6879121bb452c082562e2e6a3bb44f64b0fc5b3)

## バグ修正

- Discordで必須化されたDAVEプロトコルに対応するため `@discordjs/voice` を更新。未対応のままだとボイスチャンネルへの接続・読み上げができなくなる不具合があり (6d6c104ff6dd86e6104101c216e07b5e947d0c35)
- `voiceStateUpdate` イベントハンドラ、ステータス表示の自動更新ループ、`/dictionary`・`/import_dictionary`・`/sys_info` のボタン/セレクトメニュー操作で例外が発生した際に、未処理のPromise rejectionによりBOTプロセス全体がクラッシュする問題を修正 (78e4e88e68b132e7d70f90975baf5e75fce555bb)
...
- discord.js 更新(`14.18.0` => `14.27.0`)
- @discordjs/voice 更新(`0.18.0` => `0.19.2`)
- axios 更新(`1.8.2` => `1.16.0`)
- systeminformation 更新(`5.25.11` => `5.31.7`)
- googleapis 更新(`146.0.0` => `173.0.0`)
- その他、qs / jws / fast-uri / flatted / minimatch / uuid 等の間接依存を更新
